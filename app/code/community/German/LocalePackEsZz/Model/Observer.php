 ...
 */
class German_LocalePackEsZz_Model_Observer {

    public function adminhtmlControllerActionPredispatchStart() {

        $helper = Mage::helper("localepackeszz");
    ...
    public function getVersionNumber() {
        ...
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackEsZz/version');
    }
    ...
    public function getManageUrl() {
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackeszz'));
    }
}
